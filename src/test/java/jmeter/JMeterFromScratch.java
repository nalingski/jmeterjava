...
//        File jmeterHome = new File(System.getProperty("jmeter.home"));
        ...
        //if (jmeterHome.exists()) {
           // File jmeterProperties = new File(jmeterHome.getPath() + slash + "bin" + slash + "jmeter.properties");
            File jmeterProperties = new File("C:\\Users\\goonawardanan\\Downloads\\sw\\apache-jmeter-2.13\\bin\\jmeter.properties");
            if (jmeterProperties.exists()) {
                ...
                examplecomSampler.setPort(8000);
...
//                threadGroupHashTree.add(blazemetercomSampler);
                ...
                SaveService.saveTree(testPlanTree, new FileOutputStream("C:\\Users\\goonawardanan\\projects\\Jemter\\example.jmx"));
                ...
                String logFile = "C:\\Users\\goonawardanan\\Downloads\\sw\\apache-jmeter-2.13\\bin\\jmeter.properties" + "example.jtl";
